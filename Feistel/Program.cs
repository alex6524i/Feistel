namespace Feistel
{
    class Program
    {
        ...
        {
            var plainText = "1111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111";
            ...
            System.Console.WriteLine("Cipher: Classic Feistel. Mode: None\nplain text: {0}\nafter encoding: {1}\nafter decoding: {2}\nequals: {3}\n\n", plainText, cipherText1, plainTextAgain1, result1);
            ...
            System.Console.WriteLine("Cipher: Variant 1. Mode: None\nplain text: {0}\nafter encoding: {1}\nafter decoding: {2}\nequals: {3}\n\n", plainText, cipherText2, plainTextAgain2, result2);
            ...
            System.Console.WriteLine("Cipher: Variant 1. Mode: CBC\nplain text: {0}\nafter encoding: {1}\nafter decoding: {2}\nequals: {3}\n\n", plainText, cipherText3, plainTextAgain3, result3);
            ...
            System.Console.WriteLine("Cipher: Variant 1. Mode: CFB\nplain text: {0}\nafter encoding: {1}\nafter decoding: {2}\nequals: {3}\n\n", plainText, cipherText4, plainTextAgain4, result4);
